...
void Random_init()
{
  ...
  return srand((unsigned long)(tv.tv_usec + tv.tv_sec + getpid()));
}
...
//{
//  int c;
//  while ( ( c = getopt(argc,argv,"b:hHcC:e:fl:M:m:p:s:tu:x")) != -1)
//    switch( c ){
//    case 'b':
...
void usage()
{
  fprintf(stderr,"CTorrent 1.3 RELEASE		Copyright: YuHong(992126018601033)");
  ...
  fprintf(stderr,"-b bf_filename\tBit field filename.\n");
  ...
  fprintf(stderr,"bug report: bsdi@sina.com\n\n");
}
