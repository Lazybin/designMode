...
#define MAX_LINE_SIZ 32
  ...
  if ( r != 200 ){
	...
	return -1;
      ...
      fprintf(stderr,"Tracker reponse code >= 400 !!! Maybe file not register on this tracker \n");
      fprintf(stderr,"\tor it so old that have been removed from this tracker, IF YOU SEE THIS \n");
      fprintf(stderr,"\tMESSAGE FOR A LONG TIME AND DOWNLOAD HAVEN'T BEGIN, RECOMMEND YOU STOP NOW!!!"); 
      return -1;
    }else
      return 0;
  }
